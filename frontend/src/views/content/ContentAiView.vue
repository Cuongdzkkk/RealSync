...
const templates = [
  { name: 'Mô tả tin đăng', channel: 'listing', tone: 'Chuyên nghiệp', status: 'ready' },
  { name: 'Gói SEO meta', channel: 'seo', tone: 'Tối ưu tìm kiếm', status: 'ready' },
  { name: 'Bài Facebook/Zalo', channel: 'social', tone: 'Ngắn gọn, có CTA', status: 'review' }
];
</script>

<template>
  <ModuleShell title="Nội dung AI" description="Tạo mô tả, SEO content và bài social từ dữ liệu BĐS đã chuẩn hóa.">
    <template #actions>
      <el-button :icon="MagicStick" type="primary">Tạo nội dung</el-button>
    </template>

    <div class="content-grid">
      <section class="panel">
        <div class="panel__header">
          <h2 class="panel__title">Hàng đợi nội dung</h2>
        </div>
        <div class="panel__body">
          <ActionToolbar v-model:keyword="keyword" placeholder="Tìm nội dung..." >
            <el-button :icon="DocumentAdd">Mẫu</el-button>
          </ActionToolbar>
        </div>
      ...
      <section class="panel">
        <div class="panel__header">
          <h2 class="panel__title">Mẫu có sẵn</h2>
        </div>
