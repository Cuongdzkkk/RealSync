...
export const mockMetrics: DashboardMetric[] = [
  ...
  { label: 'Crawler active', value: 6, trend: 'live', variant: 'info' },
  { label: 'AI score TB', value: 86, suffix: '%', trend: '+3%', variant: 'success' }
];
...
export const mockNotifications: NotificationItem[] = [
  {
    id: 'n-001',
    title: 'Crawler Batdongsan hoàn tất',
    description: '342 listing mới, 18 duplicate đã loại bỏ.',
    tone: 'success',
    createdAt: '2026-05-24T09:20:00Z'
  },
  {
    id: 'n-002',
    title: 'AI confidence thấp',
    description: '3 listing cần kiểm duyệt thủ công trước khi publish.',
    tone: 'ai',
    createdAt: '2026-05-24T08:55:00Z'
  },
  {
    id: 'n-003',
    title: 'Lead nóng chưa assign',
    description: 'Nguyễn Minh Anh cần được gọi lại trong 24h.',
    tone: 'warning',
