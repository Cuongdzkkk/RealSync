        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CrawlConfig = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CrawlJobs_CrawlSources_CrawlSourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceUnit = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, defaultValue: "VND"),
                    ...
                    ListingType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Sale"),
                    FeaturedLevel = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_CrawlJobs_CrawlJobId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CrawlResults_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadActivities_Users_PerformedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrawlJobs_CrawlSourceId",
                table: "CrawlJobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrawlResults_PropertyId",
                table: "CrawlResults",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_CrawlSources_Name",
                table: "CrawlSources",
                column: "Name",
                unique: true);
